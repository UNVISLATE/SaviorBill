...
export default defineConfig({
  ...
  server: {
      ...
      proxy: {
        ...
        // billing под /api/ws/*, который тоже начинается на "/api" —
        // совпадает с этим правилом по префиксу) — billing. WS переопределять
        // отдельно не нужно: ws:true на обоих правилах покрывает и HTTP, и WS
