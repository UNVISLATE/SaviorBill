...
Отдельная таблица (не settings-ключ со списком) — быстрый индексированный
точный поиск домена при каждой регистрации, вместо парсинга JSON/CSV на
каждый запрос. См. AUDIT.md §"email.domainlist" для истории решения:
рассматривался settings-ключ и периодическая подгрузка публичных
disposable-domain листов — подгрузка внешних списков сознательно отложена
как отдельная будущая фича, эта таблица — только ручное управление админом.
"""
