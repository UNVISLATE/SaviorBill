...
def _build_body(scope: str, raw: dict[str, str]) -> dict: # TODO: собирать из любых параметров, ui.{scope}.{*} , где * - абсолютно любое имя переменной
    """Собрать тело ответа строго из settings настроек бд для UI.
